...
public class Day15 {
    public static void main(String[] args) {
        ...
        System.out.println("Output for grid1: " + solution.maximumSafenessFactor(grid1)); // Expected: 0
        ...
        System.out.println("Output for grid2: " + solution.maximumSafenessFactor(grid2)); // Expected: 2
        ...
        System.out.println("Output for grid3: " + solution.maximumSafenessFactor(grid3)); // Expected: 2
    }
}

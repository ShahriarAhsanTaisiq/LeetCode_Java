...
* A directed edge from a to b in the graph means that team a is stronger than team b and team b is weaker than team a. Team a will be the champion of the tournament if there is no team b that is stronger than team a. Return the team that will be the champion of the tournament if there is a unique champion, otherwise, return -1.
...
public class LeetCode2924 {
    public static void main(String[] args) {
        ...
        System.out.println(findChampion.findChampion(7,new int[][]{{0,1},{0,2},{1,3},{1,4},{2,5}}));
    }
}

...
public class LeetCode2337 {
    public static void main(String[] args) {
         ...
         System.out.println(movePiecesToObtainString.canChange("R", "L"));
         System.out.println(movePiecesToObtainString.canChange("_L__R__R_", "L______RR"));
         System.out.println(movePiecesToObtainString.canChange("R_L_", "__LR"));
    }
}
